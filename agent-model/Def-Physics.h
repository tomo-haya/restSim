...
#define MIN_TIME_RECRUIT	10//min recruiting period
#endif
...
#define MIN_NUM_AGENT		100//min population
#endif
...
#define MAX_NUM_AGENT		100//max population
#endif

//////////(Setting for environmental change)//////////
#ifndef MIN_NUM_INIT_PREY		
#define MIN_NUM_INIT_PREY		8//min food num
#endif
...
#define MAX_NUM_INIT_PREY		8//max food num
#endif
